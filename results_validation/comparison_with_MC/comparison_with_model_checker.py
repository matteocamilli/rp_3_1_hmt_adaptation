...
df_model_checker_to_improve = pd.read_csv("additional_datasets/configurations_to_improve/initial_configuration_to_improve_random.csv")
df_model_checker_improved = pd.read_csv("additional_datasets/MC_generated_dataframe/DPa.csv")
...
plt.savefig('results_validation/comparison_with_MC/comparison_model_checker_improved_dropna.png')
plt.close()
