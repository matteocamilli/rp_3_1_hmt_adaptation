...
if __name__ == "__main__":
    ...
    # Save the figures
    fig_SCS.savefig('results_validation/plots_and_tables_NSGAII/lime_explanation_SCS.png')
    fig_FTG.savefig('results_validation/plots_and_tables_NSGAII/lime_explanation_FTG.png')
