...
directory_path = "results_validation/uppaal_logs_renamed/uppaal_logs/RP_round2"

# Process the files and create a DataFrame
df = process_files_in_directory(directory_path)

df1 = pd.read_csv("additional_datasets/configurations_to_improve/initial_configuration_to_improve_random.csv")
...
output_csv_path = "results_validation/comparison_with_log.csv"
